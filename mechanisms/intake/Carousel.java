...
public class Carousel {
    ...
    public void spin(double new_pos) {
        carousel.setPosition(new_pos);
    }

    // Spinning Carousel for Specific Ball Color
    public void findGreenBall(ColorSensorHandler colorSensor) throws InterruptedException {
        findBall(HueValues.GREEN_MIN, HueValues.GREEN_MAX, colorSensor);
    }
    public void findPurpleBall(ColorSensorHandler colorSensor) throws InterruptedException {
        findBall(HueValues.PURPLE_MIN, HueValues.PURPLE_MAX, colorSensor);
    }
